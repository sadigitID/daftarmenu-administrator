...
<form id="login">
      ...
      <div @click="showDialogForgotPassword" class="w-full  text-primary-500 text-end mb-8">
        <p>Lupa password?</p>
      </div>
      ...
      <div class="">
        <button 
          ...
          class="justify-start py-1 m-auto font-semibold text-white border-8 rounded-lg px-36 border-primary-500 bg-primary-500"
        >
          Login
        </button>
      </div>
