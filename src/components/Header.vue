...
<template>
  ...
  >
    ...
    <div class="flex items-center">
      <button
        class="flex justify-center space-x-2.5 items-center px-4 py-2 bg-primary-50 rounded-full mr-[25px]"
      >
        <Profil class="w-6 h-6" />
        <span class="text-xs text-primary-800 font-bold">Admin</span>
      </button>
    </div>
  </header>
</template>
